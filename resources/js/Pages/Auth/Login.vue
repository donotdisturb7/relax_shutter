...
<template>
    ...
    <div class="relative flex flex-col lg:flex-row min-h-screen">
        ...
        <div
            class="relative flex flex-col items-center justify-center w-full max-w-xl px-4 mx-auto md:px-0 lg:max-w-screen-xl lg:justify-start lg:w-5/12 z-10 bg-white ounded-lg p-8"
        >
