...
<template>
    ...
    <div class="relative flex flex-col lg:flex-row min-h-screen">
        ...
        <div class="relative flex flex-col items-center justify-center w-full max-w-xl px-4 mx-auto md:px-0 lg:max-w-screen-xl lg:justify-start lg:w-5/12 z-10 bg-white rounded-lg p-8">
                ...
                <div class="flex min-h-full flex-1 flex-col justify-center">
                    ...
                    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        >
                            ...
                            <span class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Se connecter</span>
                        </Link>
                    </div>
                </div>
            </div>
